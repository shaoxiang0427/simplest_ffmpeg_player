*解决编译sdl项目时出现无法解析的外部符号 __imp__fprintf解决办法，参考链接https://blog.csdn.net/johnny_nass_hu/article/details/74035400
1、在main文件simplest_ffmpeg_player.cpp中添加 extern "C" { FILE __iob_func[3] = { *stdin,*stdout,*stderr }; }
2、在链接库中添加legacy_stdio_definitions.lib
